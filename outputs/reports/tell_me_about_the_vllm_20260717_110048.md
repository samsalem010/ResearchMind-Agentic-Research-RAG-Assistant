...
**Generated on:** 2026-07-17 11:00:48
...
* **API Compatibility**: Provides a drop-in **OpenAI-compatible HTTP server** for instant integration with existing applications [3][14]
...
* [16] [vLLM API](https://vllm.readthedocs.io/en/latest/api.html)
